...
export default function RestaurantHeader({
  ...
  const dummyLogo = "/logo.svg";
  const dummyName = "Tacos Bros";
  const dummyGoogleReview = "#";
  const dummyTripAdvisorReview = "#";
  ...
  return (
    <div className="relative w-full bg-[#4a3a2a] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-b from-transparent via-transparent to-[#4a3a2a]/80 pointer-events-none" />

      <div className="relative container mx-auto px-4 py-8 md:py-12">
        <div className="flex items-start gap-4 md:gap-6 mb-6">
          <div className="relative w-20 h-20 md:w-24 md:h-24 shrink-0 bg-black rounded-sm flex items-center justify-center p-2">
            <Image
              src={dummyLogo}
              alt={`${dummyName} logo`}
              width={80}
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex gap-3 flex-wrap">
              <Button
                ...
                onClick={() => window.open(dummyGoogleReview, "_blank")}
              >
                <svg
